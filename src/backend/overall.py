...
def meta_prompt(text):
    ...
    return f"The following is a combination of video extract summaries. Rewrite this as a structured, clear summary that keeps some of the main facts and keeps the text well structured.\n\nCombined Transcript Extracts: \"\"\"\n{text}\n\"\"\"\n"
